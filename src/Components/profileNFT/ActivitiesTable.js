...
const ActivitiesTable = () => {
  ...
  <tbody style={{fontSize:"large"}}>
    <tr>
      ...
      <td><img src="https://strugend.com/assets/images/logo/selogo4.png" style={{height:"40px", width:"80px", marginRight:"10px"}} class="rounded float-left" alt="logo"/>Untitled Collection #123456 <br/> <h6>Strugend Backside</h6> </td>
      <td>---</td>
      <td>1</td>
